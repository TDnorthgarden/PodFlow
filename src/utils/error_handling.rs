/// 错误处理辅助函数
use crate::types::error::{PodflowError, Result};
...
pub fn lock_mutex_with_error<'a, T>(
    ...
    result.map_err(|_| PodflowError::lock_error(error_msg))
}
